  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 px-2.5 py-4 space-y-0.5">
        <p
          className="text-[9px] font-semibold tracking-widest uppercase px-2.5 pb-2"
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className="flex items-center gap-2.5 px-2.5 py-2.5 rounded-lg text-sm font-medium transition-colors border-l-2"
              style={
                active
                  ? {
              ...
              onMouseEnter={(e) => {
                if (!active) {
                  ...
                  ;(e.currentTarget as HTMLAnchorElement).style.background = '#0d1724'
                }
              }}
              onMouseLeave={(e) => {
                if (!active) {
      ...
      >
        <button
          ...
          className="flex w-full items-center gap-2.5 px-2.5 py-2.5 rounded-lg text-sm font-medium transition-colors"
          style={{ color: 'var(--c-muted)' }}
          onMouseEnter={(e) => {
            ;(e.currentTarget as HTMLButtonElement).style.color = 'var(--c-offline)'
